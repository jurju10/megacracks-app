...
const TEAMS = {
    ...
    "Levante": [
      ...
      ["211","Carlos Álvarez"],["212","Tunde"],["213","Brugué"],["214","Pendiente"],
      ["215","Carlos Espí"],["216","Etta Eyong"],
    ],
    "Real Madrid": [
...
const SPECIALS = {
    "Élite": [
      ["1","Barrios · Sin firma (Atlético)"],["1P","Barrios · Firma (Atlético)"],["2","Bellingham · Sin firma (Real Madrid)"],["2P","Bellingham · Firma (Real Madrid)"],
      ["3","Budimir · Sin firma (Osasuna)"],["3P","Budimir · Firma (Osasuna)"],["4","Courtois · Sin firma (Real Madrid)"],["4P","Courtois · Firma (Real Madrid)"],
      ["5","Fede Valverde · Sin firma (Real Madrid)"],["5P","Fede Valverde · Firma (Real Madrid)"],["6","Fermín · Sin firma (Barcelona)"],["6P","Fermín · Firma (Barcelona)"],
      ["7","Giuliano · Sin firma (Atlético)"],["7P","Giuliano · Firma (Atlético)"],["8","Julián Álvarez · Sin firma (Atlético)"],["8P","Julián Álvarez · Firma (Atlético)"],
      ["9","Lamine Yamal · Sin firma (Barcelona)"],["9P","Lamine Yamal · Firma (Barcelona)"],["10","Mbappé · Sin firma (Real Madrid)"],["10P","Mbappé · Firma (Real Madrid)"],
      ["11","Moleiro · Sin firma (Villarreal)"],["11P","Moleiro · Firma (Villarreal)"],["12","Nico Williams · Sin firma (Athletic)"],["12P","Nico Williams · Firma (Athletic)"],
      ["13","Oyarzabal · Sin firma (Real Sociedad)"],["13P","Oyarzabal · Firma (Real Sociedad)"],["14","Pablo Fornals · Sin firma (Betis)"],["14P","Pablo Fornals · Firma (Betis)"],
      ["15","Pedri · Sin firma (Barcelona)"],["15P","Pedri · Firma (Barcelona)"],["16","Raphinha · Sin firma (Barcelona)"],["16P","Raphinha · Firma (Barcelona)"],
      ["17","Unai Simón · Sin firma (Athletic)"],["17P","Unai Simón · Firma (Athletic)"],["18","Vinícius · Sin firma (Real Madrid)"],["18P","Vinícius · Firma (Real Madrid)"],
    ],
    "Enjoy": [
      ["379","Abde · Rosa (Betis)"],["379P","Abde · Naranja (Betis)"],["380","Brahim Díaz · Rosa (Real Madrid)"],["380P","Brahim Díaz · Naranja (Real Madrid)"],
      ["381","Dani Olmo · Rosa (Barcelona)"],["381P","Dani Olmo · Naranja (Barcelona)"],["382","Dolan · Rosa (Espanyol)"],["382P","Dolan · Naranja (Espanyol)"],
      ["383","Íñigo Vicente · Rosa (Racing de Santander)"],["383P","Íñigo Vicente · Naranja (Racing de Santander)"],["384","Kubo · Rosa (Real Sociedad)"],["384P","Kubo · Naranja (Real Sociedad)"],
      ["385","Lookman · Rosa (Atlético)"],["385P","Lookman · Naranja (Atlético)"],["386","Pépé · Rosa (Villarreal)"],["386P","Pépé · Naranja (Villarreal)"],
